...
```
### Model Assumptions
The effect of pH and temperature were not considered in this analysis.
...
$$f_{N_{AOB}} = \frac{s_{{NO_2^-}_{amx}}}{s_{{NO_2^-}_{amx}}+s_{{NH_4^+}_{amx}}} =\frac{1.3}{1.3+1}=0.57$$
$$f_{N_{NOB}} = 0$$
...
$$f_{N_{AOB}}=f_{N_{NOB}}=\frac{s_{{NO_2^-}_{amx/ndamo}}}{s_{{NO_2^-}_{amx/ndamo}}+s_{{NH_4^+}_{amx/ndamo}}}=\frac{1}{1+1}=0.5$$
