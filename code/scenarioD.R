anamx_NDAMO_AnMBR <- function(df){
  ...
  temp$px.NDAMO<-fN_NDAMO * Y_NDAMO * temp$LN * n_conv  #kg/d, sludge produced from NDAMO
  ...
  temp$px.AnMBR <- temp$LCOD_conv * Y_AnMBR * n_conv # kg/d
  temp$CH4prod <- temp$LCOD_conv * (1-Y_AnMBR) * CH4_COD
