...
# Setup up scales
col.carbon <- colorRampPalette(c('white', 'red'))
...
levelplot(O2.demand ~ Nitrogen * Carbon, data=d,
          ...
          colorkey = list(labels=list(cex=1,
                                      ...
                                      labels=c('0 kgCOD/day', 5000, 10000, 15000, 20000, 25000))))
