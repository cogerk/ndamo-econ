anamx_NDAMO<- function(V, pH, Temp, cNin, cCODin){
  ...
  fCOD_Astage = 0.95 # Assume 95% conversion of COD in AnMBR
  ...
  px_TOT = px_Astage+px_AOB+px_NOB+px_Anamx+px_NDAMO #kg/d, total sludge produced
  ...
  CH4gas = CH4prod-LCH4_cons # Assume all Methane goes to gas phase
  ...
  Results= data.frame(V, pH, Temp, cNin, fCH4_cons, px_TOT, O2_dem, LCH4gas)
  return(Results)
  }
